...
export default{
    ...
    methods:{
        ...
        searchOrderByPhoneNumber(){
            if(this.input_phonenumber != ''){
                this.$router.push({ name: 'AdminSearchOrderByPhoneNumber', query: {phonenumber: this.input_phonenumber }});
            }
        },
    }
}
            ...
            <div class="mt-3">
                <table id="table_contain_search_order">
                    <tr>
                        ...
                        <td><input type="text" id="input_email" v-model="input_email" @keyup.enter="searchOrder()"></td>
                        <td><i class="fa-solid fa-magnifying-glass" id="icon_search" @click="searchOrder()"></i></td>
                    </tr>
                    <tr>
                        <td><label for="input_phonenumber">Hoặc nhập số điện thoại để tìm thông tin đơn hàng</label></td>
                        <td><input type="text" id="input_phonenumber" v-model="input_phonenumber" @keyup.enter="searchOrderByPhoneNumber()"></td>
